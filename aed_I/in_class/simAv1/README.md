...
<pre><strong>Input:</strong> bills = [5,5,10,20]
<strong>Output:</strong> false
<strong>Explanation:</strong> 
From the first two customers in order, we collect two $5 bills.
For the next customer in order, we collect a $10 bill and give back a $5 bill.
For the last customer, we give the change of $15 with a $10 and a $5.
